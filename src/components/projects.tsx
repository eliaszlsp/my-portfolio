    ...
    <div>
      <section className=" flex h-[1300px] w-[1440px] flex-col   items-center  py-40">
        ...
        <div className="flex flex-row">
          <div className="flex  w-[1440px] flex-row items-center gap-12   ">
            <div className=" flex w-[400px]  flex-col  items-center bg-[#8257e5] shadow-[-2px_-1px_19px_10px_rgba(0,0,0,0.75)] ">
                  ...
                  <div className={``}>
                    <Collapse isOpened={read as boolean}>
                      <p>
                        ...
                        nenhum tutorial disponível na internet ensinando a
                        clonar esse site. Dessa forma, criei um clone que
                        ninguém tinha feito, me desafiando ao aplicar meus
                        conhecimentos na prática e também aprendendo coisas
                        novas.
                      </p>
                    </Collapse>
                  </div>
